...
Desenvolver uma aplicação simples de um cronometro que utiliza constructor e estado para renderizar na tela do usuário.
Com algumas funções simples como start, pause e reset
...
![Optional_Text](../../assets/cronometro1.JPG)
![Optional_Text](../../assets/cronometro2.JPG)
