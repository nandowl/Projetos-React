...
Desenvolver uma aplicação de reserva de viagens promocionais (pacotes) com interface intuitiva e fácil para o usuário abordando os principais conceitos.
Nesse projeto não foi implementado sistema de login e pagamentos.
Foram abordados apenas os conceitos relevantes de Api, redux e redux saga para gerenciamento de estados.
...
![Optional_Text](../../assets/reservas1.JPG)
![Optional_Text](../../assets/reservas2.JPG)
